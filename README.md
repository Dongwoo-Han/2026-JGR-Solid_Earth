# Han et al. (2026), JGR
This repository contains the data used for figures regarding the manuscript titled as '*A Wide Spectrum of Frictional States in Subduction Zones: The Influence of Pre- and Post-Subduction Bending Faults*'.
