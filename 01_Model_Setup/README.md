...
where $\rho_{f0}=1036.5 kg m^{-3}$, $\{alpha}_0=1.367 \{times} 10^{-4} ^\{circ} C^{-1}$, and $\alpha_1=2.159 \times 10^{-6} ^\circ C^{-2}$  




## DataType 
**07. PermeabilityProfile:** log10(permeability) (m-2) - Figures 4 and 5