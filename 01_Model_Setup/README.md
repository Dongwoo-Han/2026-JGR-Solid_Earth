...
$\rho_f(T) = \rho_{f0}(1-\alpha_0T-\alpha_1T^2)$,  
...
$\rho_f(T, P) = \rho_{f0}(1-\alpha_0T + \beta p_0)$,  
where $\rho_{f0}=1036.5 \ kg \ m^{-3}$, $\alpha_0 \times 10^{-4} \ ^{\circ} C^{-1}$, $\beta=4 \times 10^{-10} \ Pa^{-1}$, and $p_0 = \rho_{f0} \lVert \boldsymbol{\mathrm{g}} \rVert (-y)$ (Vallis, 2017).  
