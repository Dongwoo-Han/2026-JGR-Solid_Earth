...
**03. BC Tests Results:** The calculated seafloor heat flow from the models with a different bottom boundary conditions (insulated & constant temperature corresponding to the initial slab temperature at 40-km depth) ($mW \ m^{-2}$).  
