...
**01. Boundary Conditions:** Slab Temperature (Kelvin) and Basal Heat Flux (mW m-2) calculated from large-scale thermomechanical subduction models for the Nankai and Tohoku subduction zones (Lee and Kim, 2023) - Figures 2 and 3  
...
**04. rho_fluid Results:** The calculated seafloor heat flow from the models with a different fluid density.  
